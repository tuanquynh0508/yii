...
class Category extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('category_id, title, created_at, updated_at, del_flg', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'tblProducts' => array(self::MANY_MANY, 'Product', 'tbl_product_category(category_id, product_id)'),
		);
	}
