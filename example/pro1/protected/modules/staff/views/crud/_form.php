...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'staff_account'); ?>
		<?php echo $form->textField($model,'staff_account',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'staff_account'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'staff_pwd'); ?>
		<?php echo $form->textField($model,'staff_pwd',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'staff_pwd'); ?>
	</div>
